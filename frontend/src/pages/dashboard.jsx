...
const radarOptions = {
  ...
  return (
    <div className="flex bg-[#000814] min-h-screen text-white relative overflow-hidden">
      ...
      <div className="flex-1 md:ml-56 p-6 md:p-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-10 mb-10">
            ...
            <div className="overflow-y-auto h-56 space-y-3 pr-2">
              {threatFeed.map((t, i) => (
                <div key={i} className="border-b border-red-900/40 pb-2">
                  ...
                  <span className={`text-[10px] mt-1 inline-block px-2 py-[1px] rounded-md ${severityBadge(t.severity)}`}>
                    {t.severity}
                  </span>
                </div>
              ))}
          ...
          <div className="bg-[#0A1A2F] border border-cyan-600 rounded-xl p-5 shadow-lg">
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody>
                {topIPs.map((i) => (
                  <tr key={i.ip} className="border-b border-cyan-900 hover:bg-[#112233] transition">
