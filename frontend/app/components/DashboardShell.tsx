    ...
    <div className="min-h-screen bg-[#04060a] text-gray-200 flex">
      ...
      <aside className="w-64 bg-[#021018] border-r border-cyan-900/30 p-6 flex flex-col">
        ...
        <nav className="space-y-4 text-gray-300">
          <a href="/dashboard" className="flex items-center gap-3 text-cyan-200 font-semibold">
            ⚡ Dashboard
          </a>
          <a href="/logs" className="flex items-center gap-3 hover:text-cyan-200 transition">
            📜 Logs
          </a>
          <a href="/incidents" className="flex items-center gap-3 hover:text-cyan-200 transition">
            🛡 Incidents
          </a>
        </nav>
